...
export function Home() {
  // Persist journey state across page refreshes and back-navigation
  const [hasStarted, setHasStarted] = useState(() => {
    try { return sessionStorage.getItem("journey-started") === "1"; } catch { return false; }
  });
  ...
  const chapters = [
    {
      ...
      emotion: "Possibility",
      chapterKey: "builder",
      focus: "learning, experimentation, first projects, curiosity",
    },
    {
      title: "The Problem Solver",
      narrative:
        "Most engineering problems weren't code problems. They were systems problems.",
      visualDescription:
      ...
      emotion: "Discovery",
      chapterKey: "solver",
      focus: "performance, accessibility, debugging, reliability",
    },
    {
      title: "The Architect",
      narrative:
        "Building features stopped being interesting. Building systems became the challenge.",
      visualDescription:
      ...
      focus: "Angular modernization, frontend architecture, design systems, standards",
    },
    {
      title: "The Multiplier",
      narrative:
        "The biggest impact wasn't what I built. It was what others could build because of it.",
      visualDescription:
      ...
      focus: "tooling, automation, enablement, developer experience",
    },
    {
      title: "The Mentor",
      ...
      emotion: "Connection",
      chapterKey: "mentor",
      focus: "mentoring, reviews, coaching, standards",
    },
    {
      title: "The Explorer",
      narrative:
        "The tools change. The mission stays the same. Make engineering better.",
      visualDescription:
      ...
      emotion: "Optimism",
      chapterKey: "explorer",
      focus: "AI, future workflows, experimentation",
    },
  ];
  ...
  return (
    <div className="w-full overflow-x-hidden">
      {!hasStarted ? (
        /* ── Hero: title card only — name, one claim, one CTA ── */
        <div ref={heroRef} className="h-screen w-full flex flex-col justify-center px-8 md:px-16 bg-[var(--cinema-black)]">
        ...
        <div className="w-full" ref={journeyRef}>
          {/* Engineering Through Time Title */}
          <div className="min-h-[60vh] flex items-center justify-center px-8 md:px-16 pt-24 pb-16 bg-[var(--cinema-black)]">
            ...
            >
              ...
              <button
                ...
                style={{ color: "var(--cinema-muted)", fontSize: "0.75rem", letterSpacing: "0.06em" }}
              >
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  <path d="M8 2L3 6L8 10" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span className="uppercase tracking-[0.06em]" style={{ fontWeight: 400 }}>Back to beginning</span>
              </button>
          ...
          {/* Continue exploring — Writing removed until it has content */}
                ...
                {[
                  ...
                  <Link key={to} to={to}>
                    <motion.button
                      ...
                      className="px-10 py-4 border border-[var(--cinema-border)] text-[var(--cinema-white)] tracking-[0.08em] uppercase transition-all duration-500"
                      style={{ fontWeight: 400, fontSize: "clamp(0.75rem, 1.2vw, 0.85rem)", letterSpacing: "0.08em" }}
                    >
                      {label}
                    </motion.button>
                  </Link>
